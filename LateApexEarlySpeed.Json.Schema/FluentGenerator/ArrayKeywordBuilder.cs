...
public class ArrayKeywordBuilder : KeywordBuilder
{
    ...
    private static void AddHasLengthKeyword(List<ValidationKeywordBase> keywords, uint length)
    {
        keywords.AddRange(new ValidationKeywordBase[]
        {
    ...
    public ArrayKeywordBuilder Contains(Action<JsonSchemaBuilder> configureBuilder)
    {
        ...
        _schemas.Add(new BodyJsonSchema(Enumerable.Empty<ValidationKeywordBase>(), null,
    ...
    public ArrayKeywordBuilder Single(Action<JsonSchemaBuilder> configureBuilder)
    {
        ...
        _schemas.Add(new BodyJsonSchema(Enumerable.Empty<ValidationKeywordBase>(), null, new ISchemaContainerValidationNode[] {arrayContainsValidator}, 
