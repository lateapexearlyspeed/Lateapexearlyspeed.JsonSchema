...
internal class NotContainsKeyword : KeywordBase
{
    ...
    protected internal override ValidationResult ValidateCore(JsonInstanceElement instance, JsonSchemaOptions options)
    {
        ...
        foreach (JsonInstanceElement element in instance.EnumerateArray())
        {
            ...
            {
                return ValidationResult.SingleErrorFailedResult(new ValidationError(ErrorMessage(element.ToString()), options.ValidationPathStack,
    ...
    {
        return $"Expected array to not contain any validated element but found one, instance: {instanceData}";
    }
}