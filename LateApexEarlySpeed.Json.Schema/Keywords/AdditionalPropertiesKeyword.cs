    ...
    private class Validator : IValidator
    {
        ...
        public ResultTuple Result
        {
            get
            {
                ...
                var curError = new ValidationError(ResultCode.FailedInSubSchema, ValidationError.ErrorMessageForFailedInSubSchema, _options.ValidationPathStack, _additionalPropertiesKeyword.Name, _instance.Location);
