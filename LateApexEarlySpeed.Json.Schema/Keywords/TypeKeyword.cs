...
internal class TypeKeyword : KeywordBase
{
    ...
    protected internal override ValidationResult ValidateCore(JsonInstanceElement instance, JsonSchemaOptions options)
    {
        ...
        return ValidationResult.SingleErrorFailedResult(new ValidationError(GetErrorMessage(instance.ValueKind), options.ValidationPathStack, Name, instance.Location));
    }
