...
internal class ConstKeyword : KeywordBase
{
    ...
    protected internal override ValidationResult ValidateCore(JsonInstanceElement instance, JsonSchemaOptions options)
    {
        ...
        return ValidationResult.SingleErrorFailedResult(new ValidationError(equivalentResult.DetailedMessage, options.ValidationPathStack, Name, equivalentResult.OtherLocation));
    }
}