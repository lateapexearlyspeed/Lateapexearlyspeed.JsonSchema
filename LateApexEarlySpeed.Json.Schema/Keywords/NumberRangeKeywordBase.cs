...
internal abstract class NumberRangeKeywordBase : KeywordBase
{
    ...
    protected internal override ValidationResult ValidateCore(JsonInstanceElement instance, JsonSchemaOptions options)
    {
        ...
        return _benchmarkChecker.IsInRange(instance)
            ...
            : ValidationResult.SingleErrorFailedResult(new ValidationError(_benchmarkChecker.GetErrorMessage(instance), options.ValidationPathStack, Name, instance.Location));
    }
