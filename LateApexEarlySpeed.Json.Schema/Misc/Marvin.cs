...
namespace LateApexEarlySpeed.Json.Schema.Misc;

/// <summary>
/// refer: https://github.com/dotnet/runtime/issues/50322#issuecomment-808994234
/// </summary>
internal static class Marvin
{
    /// <summary>
    /// A span-based equivalent of String.GetHashCode(). Computes an ordinal hash code. refer: https://github.com/dotnet/runtime/issues/50322#issuecomment-808994234
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int GetHashCode(ReadOnlySpan<char> value)
    {
        ulong seed = DefaultSeed;
        return ComputeHash32(MemoryMarshal.AsBytes(value), seed);
    }
