...
internal class BooleanJsonSchemaDocument : IJsonSchemaDocument
{
    ...
    {
        return AlwaysValid ? ValidationResult.ValidResult : ValidationResult.SingleErrorFailedResult(new ValidationError("Boolean false json schema document occurs", null, null, instance.Location));
    }
}