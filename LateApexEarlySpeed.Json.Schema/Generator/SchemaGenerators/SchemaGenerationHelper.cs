...
internal static class SchemaGenerationHelper
{
    ...
    {
        return new BodyJsonSchema(keywordsFromProperty, Enumerable.Empty<ISchemaContainerValidationNode>(), new SchemaReferenceKeyword(CreateRefUri(type, baseUri)), null, null, null, null, null, null);
    }
