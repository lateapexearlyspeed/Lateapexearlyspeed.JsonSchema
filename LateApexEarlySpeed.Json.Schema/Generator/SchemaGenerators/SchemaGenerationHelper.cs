...
{
    public static BodyJsonSchema GenerateSchemaForUnsignedInteger(IEnumerable<ValidationKeywordBase> keywordsFromProperty, ulong max)
    {
    ...
    public static BodyJsonSchema GenerateSchemaForSignedInteger(IEnumerable<ValidationKeywordBase> keywordsFromProperty, long min, long max)
    {
    ...
    public static BodyJsonSchema GenerateSchemaForDouble(IEnumerable<ValidationKeywordBase> keywordsFromProperty, double min, double max)
    {
    ...
    public static BodyJsonSchema GenerateSchemaForDecimal(IEnumerable<ValidationKeywordBase> keywordsFromProperty)
    {
    ...
    public static BodyJsonSchema GenerateSchemaReference(Type type, IEnumerable<ValidationKeywordBase> keywordsFromProperty, Uri baseUri)
    {
        return new BodyJsonSchema(keywordsFromProperty, null, Enumerable.Empty<ISchemaContainerValidationNode>(), new [] { new SchemaReferenceKeyword(CreateRefUri(type, baseUri)) }, null, null, null, null);
    }
    ...
    public static BodyJsonSchema GenerateSchemaForJsonType(InstanceType instanceType, IEnumerable<ValidationKeywordBase> keywordsFromProperty)
    {
    ...
    /// </summary>
    public static IEnumerable<ValidationKeywordBase> GenerateKeywordsFromType(Type type)
    {
