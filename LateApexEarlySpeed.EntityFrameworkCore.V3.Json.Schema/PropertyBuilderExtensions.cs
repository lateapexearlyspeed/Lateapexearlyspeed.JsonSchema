...
namespace LateApexEarlySpeed.EntityFrameworkCore.V3.Json.Schema
{
    ...
    {
        /// <summary>
        /// Use <paramref name="jsonSchema"/> as json schema to validate current json property
        /// </summary>
        ...
        /// <summary>
        /// Configure <see cref="JsonSchemaBuilder"/> to construct json schema to validate current json property
        /// </summary>
        /// <param name="propertyBuilder"></param>
