...
Provide fluent JSON assertions for xUnit v2.

Install:

```powershell
Install-Package LateApexEarlySpeed.Xunit.Assertion.Json
```

Use this package in xUnit v2 test projects. For xUnit v3, use `LateApexEarlySpeed.Xunit.V3.Assertion.Json` instead.
